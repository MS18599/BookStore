<%-- 
    Document   : Delete
    Created on : 19 Nov, 2018, 8:28:19 PM
    Author     : ranjeet
--%>
                    ...
                    <div class="item">
                        <div class="container">
                            ...
                            <form action="Delete" method="post">
                              ...
                              <br>
                               <input type="text" class="form-control" name="authorname" placeholder="Author Name" autocomplete="off">
                               <br>
                                <input type="text" class="form-control" name="isbn" placeholder="ISBN" autocomplete="off">
                                <br>
                                 <textarea type="text" class="form-control" name="description" placeholder="Description" autocomplete="off"></textarea>
                                 <br>
